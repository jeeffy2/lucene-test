...
public class LuceneBase {
	    ...
	    protected Analyzer standardAnalyzer = new StandardAnalyzer(Version.LUCENE_36);
	    //中文分析器  
	    protected Analyzer smartChineseAnalyzer = new SmartChineseAnalyzer(Version.LUCENE_36,true);  
	    protected Analyzer smartIKAnalyzer = new IKAnalyzer(true);
	    protected Analyzer ikAnalyzer = new IKAnalyzer();
	    protected Analyzer cjkAnalyzer = new CJKAnalyzer(Version.LUCENE_36);
